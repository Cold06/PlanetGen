...
#include "LODDebugger.generated.h"
...
class PLANETGENERATOR_API ULODDebugger : public UProceduralMeshComponent
{
	GENERATED_BODY()

public:	
	ULODDebugger(const FObjectInitializer& ObjectInitializer);
	...
	void ApplyComponentInstanceData(struct FLODDebuggerInstanceData* ComponentInstanceData, const bool bPostUCS);
...
public:
	...
	friend struct FLODDebuggerInstanceData;
};

USTRUCT()
struct FLODDebuggerInstanceData : public FSceneComponentInstanceData {
	GENERATED_BODY()
...
public:
	FLODDebuggerInstanceData() {}
	explicit FLODDebuggerInstanceData(const ULODDebugger* SourceComponent)
		: FSceneComponentInstanceData()
	{
		bUseForceVirtualApplyCheck = false;
	}
	virtual ~FLODDebuggerInstanceData() = default;
	...
	virtual void ApplyToComponent(UActorComponent* Component, const ECacheApplyPhase CacheApplyPhase) override {
		...
		CastChecked<ULODDebugger>(Component)->ApplyComponentInstanceData(
				this, bIsPostUCS);	
	}
};
